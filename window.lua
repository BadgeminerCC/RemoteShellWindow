--- Window API with remote capibilitys
--
-- @module RemoteShell.window
-- @since 1.6
...
local function create(parent, nX, nY, nWidth, nHeight, bStartVisible,output)
    ...
    function window.blit(sText, sTextColor, sBackgroundColor)
        ...
        output:blit(sText, sTextColor, sBackgroundColor)
